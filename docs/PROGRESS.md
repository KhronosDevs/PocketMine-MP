...
| 10: Complete Data & API Layer | ✅ Done | api-ecs-rewrite / 10.4-persistence-roundtrip | #26 + #30 | ChunkStore, BlockRegistry, ItemRegistry, WorldConfig; all `// Simplified` stubs removed; real block/chunk/inventory/world APIs; **world persistence round-trip proven** |
