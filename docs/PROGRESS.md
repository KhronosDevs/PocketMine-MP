...
**Current Phase:** 12 (Networking end-to-end, permissions wiring, perf push)
...
50. ⏳ **Next** — see docs/PLAN.md §5/§12/§13 for the remaining roadmap