...
| 9: Wire the Threading | ✅ Done | followups-9.2c-9.5 / 9.4b | #27 + next | RegionThread snapshot pipeline, NetworkThread batching, async chunk gen, migration + dynamic load balancing, scaling proof |
