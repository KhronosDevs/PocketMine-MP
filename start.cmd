...
:: Phase-8 API rewrite).
set "POCKETMINE_FILE=bootstrap.php"
if not exist "%POCKETMINE_FILE%" (
...
if exist "bin\mintty.exe" (
    ...
    bin\mintty.exe -o Columns=130 -o Rows=32 -o AllowBlinking=0 -o FontQuality=3 -o Font="DejaVu Sans Mono" -o FontHeight=10 -o CursorType=0 -o CursorBlinks=1 -h error -t "PocketMine-MP" -i bin\pocketmine.ico "%PHP_BINARY%" -d memory_limit=512M -d extension=ffi -d ffi.enable=1 "%POCKETMINE_FILE%" --enable-ansi %*
) else (
